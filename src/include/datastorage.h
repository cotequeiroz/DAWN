...
struct probe_metric_s {
    ...
    int rssi_2g; // eval_probe_metric()()
    int rssi_5g; // eval_probe_metric()()
    int low_rssi_2g; // eval_probe_metric()()
    int low_rssi_5g; // eval_probe_metric()()
    int freq; // eval_probe_metric()()
    int chan_util; // eval_probe_metric()()
    int max_chan_util; // eval_probe_metric()()
    int rssi_2g_val; // eval_probe_metric()()
    int rssi_5g_val; // eval_probe_metric()()
    int low_rssi_2g_val; // eval_probe_metric()()
    int low_rssi_5g_val; // eval_probe_metric()()
...
typedef struct probe_entry_s {
    ...
    uint8_t ssid[SSID_MAX_LEN]; // parse_to_beacon_rep()
