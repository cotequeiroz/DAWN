        ...
        else if (strcmp(*argv, "dawn") == 0) // Load metrics that configure DAWN
        {
            ...
            while (ret == 0 && curr_arg + args_required < argc)
            {
                ...
                if (!strcmp(fn, "default"))
                {
                    ...
                    dawn_metric.rssi_2g = 10; // Sum component
                    dawn_metric.rssi_5g = 10; // Sum component
                    dawn_metric.low_rssi_2g = -500; // Sum component
                    dawn_metric.low_rssi_5g = -500; // Sum component
                    dawn_metric.freq = 100; // Sum component
                    dawn_metric.chan_util = 0; // Sum component
                    dawn_metric.max_chan_util = -500; // Sum component
                    dawn_metric.rssi_2g_val = -60;
                    dawn_metric.rssi_5g_val = -60;
                    dawn_metric.low_rssi_2g_val = -80;
                    dawn_metric.low_rssi_5g_val = -80;
                ...
                else if (!strncmp(fn, "rssi_2g=", 8)) load_int(&dawn_metric.rssi_2g, fn + 8);
                else if (!strncmp(fn, "rssi_5g=", 8)) load_int(&dawn_metric.rssi_5g, fn + 8);
                else if (!strncmp(fn, "low_rssi_2g=", 12)) load_int(&dawn_metric.low_rssi_2g, fn + 12);
                else if (!strncmp(fn, "low_rssi_5g=", 12)) load_int(&dawn_metric.low_rssi_5g, fn + 12);
                ...
                else if (!strncmp(fn, "rssi_2g_val=", 12)) load_int(&dawn_metric.rssi_2g_val, fn + 12);
                else if (!strncmp(fn, "rssi_5g_val=", 12)) load_int(&dawn_metric.rssi_5g_val, fn + 12);
                else if (!strncmp(fn, "low_rssi_2g_val=", 16)) load_int(&dawn_metric.low_rssi_2g_val, fn + 16);
                else if (!strncmp(fn, "low_rssi_5g_val=", 16)) load_int(&dawn_metric.low_rssi_5g_val, fn + 16);
